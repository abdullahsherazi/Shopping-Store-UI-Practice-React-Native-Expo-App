...
export default class RenderItems_ListView extends React.Component {
    constructor(props){
      super(props);}
  render(){
    return(
      <View>
        <TouchableOpacity   onPress={() => this.props.navigation.navigate('ItemInformation',{ItemPrice:this.props.ItemPrice,ItemName:this.props.ItemName,ItemPhoto:this.props.ItemPhoto})} >
            ...
            {/* ITEM IMAGE */}
                ...
                <Text style={{textAlign:"center",fontWeight:"bold",color:"white"}}>{this.props.ItemSale}% {i18n.t('sale')}</Text>
                </View>
                </View>
            </View>
        {/* hr  */}
